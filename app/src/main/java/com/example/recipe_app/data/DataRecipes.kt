...
object DataRecipes {
    ...
    val dataBreakfast: ArrayList<Recipes>
        get() {
            val listBreakfast = arrayListOf<Recipes>()
            for (position in nameBreakfast.indices) {
                val recipes = Recipes(
                    name = nameBreakfast[position],
                    category = categoryBreakfast[position],
                    description = descriptionBreakfast[position],
                    ingredients = ingredientsBreakfast[position],
                    instructions = instructionsBreakfast[position],
                    pictures = photoBreakfast[position],
                    number = numberBreakfast[position],
                    calories = caloriesBreakfast[position],
                    carbo = carboBreakfast[position],
                    protein = proteinBreakfast[position]
                )
    ...
    val descriptionDessert = arrayOf(
        ...
        "Kue dadar yang dibuat dari terigu, telur ayam, gula dan susu. Bahan-bahan dicampur dengan air membentuk adonan kental yang digoreng di atas wajan datar yang diolesi sedikit minyak.",
        "Minuman segar dengan warna hijau yang begiu menggugah selera.",
        "Minuman bubble tea atau minuman teh susu dengan isian boba atau bola tapioka, memiliki banyak varian rasa.",
        "Chocolate Pudding Mix Choco Truffle MamaSuka merupakan puding bubuk dengan perpaduan rasa cokelat yang kuat tetapi tidak pahit dengan tekstur yang lembut.",
        "Merupakan sejenis makanan yang terdiri dari campuran buah-buahan . Salad buah dikategorikan sebagai makanan sehat karena dari komposisinya yang terdiri dari buah-buahan kita dapat mengetahui bahwa salad buah adalah makanan yang banyak mengandung serat, nutrisi dan vitamin yang sangat bagus untuk menjaga kesehatan tubuh.",
        "Minuman kesehatan organik yang terbuat dari sayuran dan buah-buahan. Penampilannya menyerupai jus buah tetapi lebih kental seperti milk shake (susu kocok), karena tidak melalui proses penyaringan.",
    ...
    val ingredientsDessert = arrayOf(
        ...
        "200 gr tepung tapioka/tepung sagu\n80 gr gula merah\n130 ml air",
    ...
    val instructionsDessert = arrayOf(
        ...
        "1. Kocok lepas telur,tambahkan pisang halus,susu cair,garam dan butter leleh,aduk rata,sisihkan.\n2. Dalam wadah terpisah campur bahan kering,terigu,gula pasir dan baking powder,aduk rata\n3. Tuang adonan pisang dan susu kedalan adonan kering,aduk perlahan sampai tercampur rata.\n4. Panaskan wajan datar,tuang 1 sendok sayur,tunggu sampai bagian bawah pancake berwarna coklat baru balik dan masak sampai matang,angkat.Lakukan sampai habis dan banana pancake siap disajikan dg berbagai topping sesuai selera.",
        "1. Campur semua bahan jadi satu, gula pasir, air, pasta pandan, aduk rata. Masak dengan api sedang sambil sesekali diaduk sampai mendidih\n2. Matikan api, diamkan sampai uap panasnya hilang. Simpan di kulkas\n3. Setelah cincau jadi potong-potong sesuai selera, siap digunakan untuk campuran es dan minuman\n4. Sajikan.",
        "1. Rebus air dan gula merah sampai mendidih, angkat dan saring\n2. Masukkan tepung tapioka ke dalam larutan gula yang masi panas. Aduk-aduk rata dan biarkan hangat\n3. Ulen dengan tangan sampai lembut\n4. Bentuk bola-bola kecil\n5. Taburkan sedikit saja tepung tapioka supaya bulatan tidak lengket\n6. Saring supaya tepung tidak terlalu banyak yang lengket\n7. Rebus didalam air mendidih, aduk-aduk terus supaya tidak lengket\n8. Saring dan tiriskan\n9. Masukkan gula merah 220gr dan 450 ml air\n10. Masak bersama beberapa helai pandan\n11. Masukkan boba yang sudah direbus tadi\n12. Masak lagi sampai larutan gula merah kental\n13. Brown sugar bubble siap disajikan bersama kopi susu atau minuman lainnya",
        "1. Campurkan 1 kg Premix Puding Chocolate dengan 3000 cc air (15 gelas)\n2. Panaskan dengan api sedang hingga mendidih. Biarkan mendidih selama beberapa detik sebelum diangkat\n3. Angkat dan tuang dalam gelas/cetakan\n4. Tambahkan whipcream dan chocochips sesuai selera.",
        "1. Iris2 buah2an semua sesuai selera\n2. Masukan yakult, mayonaise, skm sesuai selera, diaduk2, baru masukan buah2an. Dan keju parut sbg toping.",
        "1. Siapkan Bahan Bahan\n2. Masukkan semua bahan kedalam Blender, lalu blender hingga halus.\n3. Tuang kedalam gelas, smoties siap disajikan. Selesai",
    ...
    val photoDessert = arrayOf(
        ...
        "https://i.ibb.co/0tyWPMP/a1d996787de27907f4320c1796672509.jpg",
        "https://i.ibb.co/GJSzFZ4/Es-Cincau-Pandan-1140x550.jpg",
        "https://i.ibb.co/2WMRKM0/b73bcf8b-7c61-4958-9936-5b6b66020214.jpg",
        "https://i.ibb.co/G2xXMds/Chocolate-Pudding-1.jpg",
        "https://i.ibb.co/XVry6hF/3007504026.jpg",
        "https://i.ibb.co/xzfV5QF/download-1.jpg",
    ...
    val dataDessert: ArrayList<Recipes>
        get() {
            val listDessert = arrayListOf<Recipes>()
            for (position in nameDessert.indices) {
                val recipes = Recipes(
                    name = nameDessert[position],
                    category = categoryDessert[position],
                    description = descriptionDessert[position],
                    ingredients = ingredientsDessert[position],
                    instructions = instructionsDessert[position],
                    pictures = photoDessert[position],
                    number = numberDessert[position],
                    calories = caloriesDessert[position],
                    carbo = carboDessert[position],
                    protein = proteinDessert[position]
                )
                listDessert.add(recipes)
            }
            return listDessert
        }
    //vegetarian
    ...
    val descriptionVegetarian = arrayOf(
        ...
        "Mengingatkan pada cabai klasik Anda, cabai lentil vegetarian ini dilengkapi dengan gula, cuka, dan rempah-rempah. Lentil bersinar, tetapi tidak terlalu bersahaja. Kacang-kacangan dan tomat memberikan tekstur pedas pada cabai, banyak protein, dan hampir setengah dari kebutuhan serat harian Anda. Sajikan dengan roti jagung dan mainkan dengan topping Anda, tambahkan bawang merah, atau alpukat, bahkan Frito ke dalam campuran.",
        "Kekayaan kaldu berasal dari soffrito versi Asia, pasta starter Italia yang memberi rasa begitu banyak sup dan saus yang lezat. Sedangkan versi Italia adalah campuran tumis seledri, bawang bombay, bawang putih, paprika, dan terkadang pasta tomat, versi ini menggunakan miso, bawang merah, jahe, dan bawang putih yang ditumis dalam minyak wijen hingga kecoklatan dan karamel. Kami memilih miso merah di sini, jenis yang paling asin dan paling pedas. Jika Anda hanya memiliki miso putih, itu juga akan berhasil. Anda mungkin hanya ingin menambahkan sedikit kecap asin untuk memperdalam rasa.",
        "Taburan tepung jagung membuat adonan tidak menempel pada batu pizza dan membuat bagian bawah kerak menjadi ekstra renyah. Jika Anda tidak memiliki batu pizza persegi panjang, gunakan loyang yang tebal sebagai gantinya. Anda sering dapat menemukan mozzarella segar di bagian keju khusus toko kelontong. Gerimis glasir balsamic yang tajam memberikan keseimbangan sempurna untuk sayuran musim panas yang manis. Sajikan dengan salad sisi hijau. Membiarkan adonan mencapai suhu kamar akan memudahkan proses penggulungan. Tomat tinggi musim panas adalah bintang di sini. Lihatlah adonan pizza segar yang didinginkan untuk mendapatkan pai berkualitas pizzeria di rumah.",
        "Alih-alih saus atau lauk, kami menyajikan hidangan Provençal ini seperti aslinya—rebusan sederhana dan sederhana. Ini adalah cara yang bagus untuk menggunakan seikat produk musim panas puncak. Anda juga dapat menggandakan rebusan dan mendinginkannya hingga 1 minggu ke depan, lalu disajikan apa adanya, disendok di atas polenta, atau dengan ayam atau ikan panggang. Anda menginginkan konsistensi rebusan yang hangat daripada sup di sini; sisakan 1/2 cangkir cairan tomat kalengan sudah cukup. Jika Anda ingin menggunakan tomat matang segar, mulailah dengan 2 pon, belah dua dan tanam 1 pon sebelum dipotong dadu.",
        "Mangkuk sayuran-berat ini penuh dengan kerenyahan dan warna, berkat wortel dan buncis yang renyah, kangkung segar, dan saus alpukat yang semarak. Ini juga memberikan lebih dari 50fi dosis serat harian Anda, kunci untuk menurunkan berat badan, energi, dan pencernaan yang sehat. Bulgur, juga disebut gandum pecah-pecah, adalah gandum utuh yang dimasak dengan cepat. Mangkuk-mangkuk ini juga akan menjadi makan siang yang luar biasa. Kemas campuran alpukat secara terpisah, tambahkan sedikit air untuk mengencerkannya sesuai kebutuhan.",
        "Resep ini cocok dengan: Kotak Makan Siang Salad Farro",
    ...
    val instructionsVegetarian = arrayOf(
        ...
        "1. Panaskan minyak dalam oven Belanda besar dengan api sedang-tinggi. Tambahkan bawang merah dan paprika dan masak, aduk sesekali, sampai sedikit lunak, sekitar 6 menit. Tambahkan bawang putih, bubuk cabai, jinten, dan 1 sdt. garam, aduk terus selama 1 menit. Tambahkan kaldu, tomat, dan lentil dan didihkan. Kurangi panas menjadi sedang dan didihkan, tutup sebagian, sampai lentil empuk, sekitar 25 hingga 30 menit. Tambahkan kacang merah, gula merah, sherry, dan sisa 1/2 sendok teh garam. Kurangi panas menjadi rendah dan aduk sesekali sampai kacang dipanaskan, sekitar 5 menit.\n2. Sendok cabai ke dalam mangkuk dan taburi dengan keju, krim asam, daun ketumbar, dan irisan jalapeno.",
        "1. Panaskan minyak dalam panci besar dengan api sedang-tinggi. Tambahkan miso, bawang bombay, dan jahe; tumis 10 menit atau sampai kecoklatan dan harum. Tambahkan bawang putih; tumis 2 menit. Tambahkan 4 gelas air, kaldu, dan jamur. Didihkan.\n2. Masukkan telur dengan hati-hati ke dalam kaldu; kurangi panas menjadi sedang. Didihkan 7 menit. Menggunakan sendok berlubang, pindahkan telur ke mangkuk berisi air es. Diamkan 1 menit. Kupas telur.\n3. Tambahkan soba dan wortel ke dalam kaldu; tingkatkan panas menjadi sedang-tinggi, dan didihkan. Kurangi panas menjadi sedang-rendah; didihkan 15 menit atau sampai soba empuk.\n4. Tambahkan bok choy dan daun bawang; masak sampai empuk, sekitar 5 menit. Aduk dalam cuka. Sendok sup secara merata ke dalam 4 mangkuk. Potong telur menjadi dua memanjang; tempatkan 2 bagian telur di setiap mangkuk sup.",
        "1. Tempatkan batu pizza persegi panjang di oven, dan panaskan hingga 500 ° F. (Jangan lepaskan batu pizza saat oven memanas.)\n2. Tempatkan adonan dalam mangkuk tahan microwave. Tutup dengan bungkus plastik, dan microwave pada HIGH 30 detik, sampai adonan sedikit hangat. Tempatkan adonan di atas permukaan yang ditaburi sedikit tepung, dan gulung menjadi persegi panjang berukuran 15 x 12 inci. Taburkan tepung jagung pada selembar kertas perkamen besar, letakkan adonan persegi panjang di atas tepung jagung. Diamkan 5 menit.",
        "1. Tiriskan 1 kaleng tomat dalam saringan di atas mangkuk, sisakan 1/2 cangkir cairan. Tiriskan sisa 1 kaleng tomat; buang cairan. Campurkan tomat, cairan 1/2 cangkir yang disediakan, dan buncis dalam mangkuk.\n2. Panaskan 1 sendok makan minyak dalam wajan besar di atas sedang-tinggi. Tambahkan bawang putih, 1/2 sendok teh garam, dan 5 bahan berikutnya (melalui terong); tumis 7 sampai 8 menit atau sampai sedikit empuk. Aduk campuran tomat dan sisa 1/2 sendok teh garam; tutup, dan masak 5 menit.\n3.Mengungkap panci; aduk dalam cuka, paprika, dan lada hitam. Masak 5 menit atau sampai campuran sayuran sedikit mengental. Bagi campuran sayuran di antara 4 mangkuk dangkal; gerimis porsi secara merata dengan sisa 1 1/2 sendok teh minyak. Taburi dengan daun kemangi, jika diinginkan. ",
        "1. Campurkan 1 cangkir air mendidih dan bulgur dalam mangkuk sedang. Diamkan 10 menit; tiriskan dengan baik.\n2. Tepuk buncis kering dengan handuk kertas. Panaskan minyak canola dalam wajan besar dengan api besar. Tambahkan buncis dan wortel; masak, aduk sesekali, sampai buncis kecoklatan, sekitar 6 menit. Tambahkan kangkung; tutup dan masak sampai kale sedikit layu dan wortel empuk, sekitar 2 menit. Tambahkan campuran buncis, bawang merah, peterseli, 1/2 sendok teh garam, dan merica ke bulgur, aduk.\n3. Proses alpukat, minyak zaitun, jus, 1 sendok makan air, tahini, bawang putih, kunyit, dan sisa 1/4 sendok teh garam dalam food processor sampai halus. Bagi campuran bulgur di antara 4 mangkuk; gerimis secara merata dengan campuran alpukat.",
        "1. Didihkan 4 gelas air dalam panci kecil. Tambahkan kacang hijau; masak 3 sampai 5 menit atau sampai renyah-lunak. Tiriskan, dan bilas dengan air dingin; menguras.\n2. Campurkan cuka, minyak, mustard, garam, dan merica dalam mangkuk sedang, aduk dengan pengocok. Panaskan farro sesuai petunjuk kemasan. Tambahkan farro, kangkung, tomat, dan kacang hijau ke dalam saus; lempar dengan baik. Taburi dengan keju.",
    ...
    val photoVegetarian = arrayOf(
        ...
        "https://i.ibb.co/FmcLQ5q/download-5.jpg",
        "https://i.ibb.co/ynh5RL6/image-2.jpg",
        "https://i.ibb.co/CtYXQZp/image-3.jpg",
        "https://i.ibb.co/3191xFV/image-4.jpg",
        "https://i.ibb.co/DGBkThY/Cooking-Light-Kale-Chickpea-Grain-Bowl-Avo-Tahini-Dressing.jpg",
        "https://i.ibb.co/PzZj0Bw/download-6.jpg",
        "https://i.ibb.co/4pRTgrd/image-6.jpg"
    )
    val numberVegetarian = arrayOf(
        "20 K",
        "30 K",
        "20 K",
        "26 K",
    ...
    val dataVegetarian: ArrayList<Recipes>
        get() {
            val listVegetarian = arrayListOf<Recipes>()
            for (position in nameVegetarian.indices) {
                val recipes = Recipes(
                    name = nameVegetarian[position],
                    category = categoryVegetarian[position],
                    description = descriptionVegetarian[position],
                    ingredients = ingredientsVegetarian[position],
                    instructions = instructionsVegetarian[position],
                    pictures = photoVegetarian[position],
                    number = numberVegetarian[position],
                    calories = caloriesVegetarian[position],
                    carbo = carboVegetarian[position],
                    protein = proteinVegetarian[position]
                )
                listVegetarian.add(recipes)
            }
            return listVegetarian
        }
